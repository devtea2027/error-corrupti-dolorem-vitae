...
<img align="right" width="94" height="71"
     src="https://postcss.github.io/@devtea2027/error-corrupti-dolorem-vitae/logo.svg"
...
Twitter account for news and releases: [@@devtea2027/error-corrupti-dolorem-vitae].

<a href="https://evilmartians.com/?utm_source=@devtea2027/error-corrupti-dolorem-vitae">
<img src="https://evilmartians.com/badges/sponsored-by-evil-martians.svg" alt="Sponsored by Evil Martians" width="236" height="54">
</a>

[interactive demo]: https://@devtea2027/error-corrupti-dolorem-vitae.github.io/
[@@devtea2027/error-corrupti-dolorem-vitae]:    https://twitter.com/@devtea2027/error-corrupti-dolorem-vitae
[Can I Use]:        https://caniuse.com/
[cult-img]:         https://cultofmartians.com/assets/badges/badge.svg
[PostCSS]:          https://github.com/postcss/postcss
[cult]:             https://cultofmartians.com/tasks/@devtea2027/error-corrupti-dolorem-vitae-grid.html
...
* [Browsers](#browsers)
* [FAQ](#faq)
  * [Does Autoprefixer polyfill Grid Layout for IE?](#does-@devtea2027/error-corrupti-dolorem-vitae-polyfill-grid-layout-for-ie)
  * [Does it add polyfills?](#does-it-add-polyfills)
  * [Why doesn’t Autoprefixer add prefixes to `border-radius`?](#why-doesnt-@devtea2027/error-corrupti-dolorem-vitae-add-prefixes-to-border-radius)
  * [Why does Autoprefixer use unprefixed properties in `@-webkit-keyframes`?](#why-does-@devtea2027/error-corrupti-dolorem-vitae-use-unprefixed-properties-in--webkit-keyframes)
  * [How to work with legacy `-webkit-` only code?](#how-to-work-with-legacy--webkit--only-code)
  * [Does Autoprefixer add `-epub-` prefix?](#does-@devtea2027/error-corrupti-dolorem-vitae-add--epub--prefix)
  * [Why doesn’t Autoprefixer transform generic font-family `system-ui`?](#why-doesnt-@devtea2027/error-corrupti-dolorem-vitae-transform-generic-font-family-system-ui)
* [Usage](#usage)
  * [Gulp](#gulp)
  * [Webpack](#webpack)
  * [CSS-in-JS](#css-in-js)
...
option or the `/* @devtea2027/error-corrupti-dolorem-vitae grid: autoplace */` control comment.
...
[The guide about Grids in IE and Autoprefixer]: https://css-tricks.com/css-grid-in-ie-css-grid-and-the-new-@devtea2027/error-corrupti-dolorem-vitae/
...
In Gulp you can use [gulp-postcss] with `@devtea2027/error-corrupti-dolorem-vitae` npm package.

```js
gulp.task('@devtea2027/error-corrupti-dolorem-vitae', () => {
  const @devtea2027/error-corrupti-dolorem-vitae = require('@devtea2027/error-corrupti-dolorem-vitae')
  const sourcemaps = require('gulp-sourcemaps')
  const postcss = require('gulp-postcss')

  return gulp.src('./src/*.css')
    .pipe(sourcemaps.init())
    .pipe(postcss([ @devtea2027/error-corrupti-dolorem-vitae() ]))
...
In [webpack] you can use [postcss-loader] with `@devtea2027/error-corrupti-dolorem-vitae`
...
module.exports = {
  plugins: [
    require('@devtea2027/error-corrupti-dolorem-vitae')
  ]
}
```
...
```sh
npm install postcss postcss-cli @devtea2027/error-corrupti-dolorem-vitae
npx postcss *.css --use @devtea2027/error-corrupti-dolorem-vitae -d build/
```
...
* **Grunt:** [grunt-postcss]
* **Ruby on Rails**: [@devtea2027/error-corrupti-dolorem-vitae-rails]
* **Neutrino**: [neutrino-middleware-postcss]
* **Jekyll**: add `@devtea2027/error-corrupti-dolorem-vitae-rails` and `jekyll-assets` to `Gemfile`
* **Brunch**: [postcss-brunch]
* **Broccoli**: [broccoli-postcss]
* **Middleman**: [middleman-@devtea2027/error-corrupti-dolorem-vitae]
* **Mincer**: add `@devtea2027/error-corrupti-dolorem-vitae` npm package and enable it:
  `environment.enable('@devtea2027/error-corrupti-dolorem-vitae')`

[neutrino-middleware-postcss]: https://www.npmjs.com/package/neutrino-middleware-postcss
[middleman-@devtea2027/error-corrupti-dolorem-vitae]:      https://github.com/middleman/middleman-@devtea2027/error-corrupti-dolorem-vitae
[@devtea2027/error-corrupti-dolorem-vitae-rails]:          https://github.com/ai/@devtea2027/error-corrupti-dolorem-vitae-rails
...
* **Stylus**: [@devtea2027/error-corrupti-dolorem-vitae-stylus]
* **Compass**: [@devtea2027/error-corrupti-dolorem-vitae-rails#compass]

[less-plugin-autoprefix]: https://github.com/less/less-plugin-autoprefix
[@devtea2027/error-corrupti-dolorem-vitae-stylus]:    https://github.com/jenius/@devtea2027/error-corrupti-dolorem-vitae-stylus
[@devtea2027/error-corrupti-dolorem-vitae-rails#compass]:     https://github.com/ai/@devtea2027/error-corrupti-dolorem-vitae-rails#compass


#### GUI Tools

* [CodeKit](https://codekitapp.com/help/@devtea2027/error-corrupti-dolorem-vitae/)
...
postcss([ @devtea2027/error-corrupti-dolorem-vitae ]).process(css).then(result => {
...
You can use [html-@devtea2027/error-corrupti-dolorem-vitae] to process HTML with inlined CSS.

[html-@devtea2027/error-corrupti-dolorem-vitae]: https://github.com/RebelMail/html-@devtea2027/error-corrupti-dolorem-vitae
[standalone build]:  https://raw.github.com/ai/@devtea2027/error-corrupti-dolorem-vitae-rails/master/vendor/@devtea2027/error-corrupti-dolorem-vitae.js
[PostCSS]:           https://github.com/postcss/postcss
...
* [Visual Studio Code](https://github.com/mrmlnc/vscode-@devtea2027/error-corrupti-dolorem-vitae)
* [Sublime Text](https://github.com/sindresorhus/sublime-@devtea2027/error-corrupti-dolorem-vitae)
...
[issue on GitHub]: https://github.com/devtea2027/error-corrupti-dolorem-vitae/issues
...
```js
@devtea2027/error-corrupti-dolorem-vitae({ grid: 'autoplace' })
```
...
.b {
  /* @devtea2027/error-corrupti-dolorem-vitae: off */
  transition: 1s; /* will not be prefixed */
}

.c {
  /* @devtea2027/error-corrupti-dolorem-vitae: ignore next */
  transition: 1s; /* will not be prefixed */
...
* `/* @devtea2027/error-corrupti-dolorem-vitae: (on|off) */`: enable/disable all Autoprefixer translations for the
  whole block both *before* and *after* the comment.
* `/* @devtea2027/error-corrupti-dolorem-vitae: ignore next */`: disable Autoprefixer only for the next property
  or next rule selector or at-rule parameters (but not rule/at‑rule body).
* `/* @devtea2027/error-corrupti-dolorem-vitae grid: (autoplace|no-autoplace|off) */`: control how Autoprefixer handles
...
@supports (transition: all) {
  /* @devtea2027/error-corrupti-dolorem-vitae: on */
  a {
    /* @devtea2027/error-corrupti-dolorem-vitae: off */
  }
}
...
Function `@devtea2027/error-corrupti-dolorem-vitae(options)` returns a new PostCSS plugin.
See [PostCSS API] for plugin usage documentation.

```js
@devtea2027/error-corrupti-dolorem-vitae({ cascade: false })
```
...
* `grid` (false|`"autoplace"`|`"no-autoplace"`): should Autoprefixer
  add IE 10-11 prefixes for Grid Layout properties?
    ...
    * `"autoplace"`: enable Autoprefixer grid translations
      ...
      `/* @devtea2027/error-corrupti-dolorem-vitae grid: autoplace */` in your CSS.
    * `"no-autoplace"`: enable Autoprefixer grid translations
      but *exclude* autoplacement support. You can also use
      `/* @devtea2027/error-corrupti-dolorem-vitae grid: no-autoplace */` in your CSS.
...
```
npm install @devtea2027/error-corrupti-dolorem-vitae@latest cross-env --save-dev
```
...
the `/* @devtea2027/error-corrupti-dolorem-vitae grid: autoplace */` control comment or
...
.grid {
  /* @devtea2027/error-corrupti-dolorem-vitae grid: no-autoplace */
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  grid-template-rows: repeat(3, 1fr);
}
...
`/* @devtea2027/error-corrupti-dolorem-vitae grid: no-autoplace */` control comment share identical
functionality to the `grid: true` setting and the `/* @devtea2027/error-corrupti-dolorem-vitae grid: on */`
...
Run `npx @devtea2027/error-corrupti-dolorem-vitae --info` in your project directory to check
which browsers are selected and which properties will be prefixed:

```console
$ npx @devtea2027/error-corrupti-dolorem-vitae --info
Browsers:
  Edge: 16
...
```js
console.log(@devtea2027/error-corrupti-dolorem-vitae().info())
```
...
The maintainers of `@devtea2027/error-corrupti-dolorem-vitae` and thousands of other packages are working
with Tidelift to deliver commercial support and maintenance for the open source
dependencies you use to build your applications. Save time, reduce risk,
and improve code health, while paying the maintainers of the exact dependencies
you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@devtea2027/error-corrupti-dolorem-vitae?utm_source=npm-@devtea2027/error-corrupti-dolorem-vitae&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)
